...
import blogGreece from "@/assets/blog-greece.jpg";
import blogIceland from "@/assets/blog-iceland.jpg";
import blogJapan from "@/assets/blog-japan.jpg";
import blogMorocco from "@/assets/blog-morocco.jpg";
import blogMountains from "@/assets/blog-mountains.jpg";
import blogSafari from "@/assets/blog-safari.jpg";
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-muted-foreground">
              Our most loved travel adventures
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto">
              Join our community of travelers and get inspired by stories from
